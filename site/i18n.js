...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      card_soon_desc: "TVA avancée, ressources humaines (CP), aides régionales — en préparation.",
    ...
    nl: {
      ...
      card_soon_desc: "Geavanceerde btw, personeel (PC), gewestelijke steun — in voorbereiding.",
