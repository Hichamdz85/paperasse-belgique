...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      card_soon_desc: "Indépendant / personne physique (IPP), TVA avancée, ressources humaines (CP), aides régionales — en préparation.",
    ...
    nl: {
      ...
      card_soon_desc: "Zelfstandige / natuurlijke persoon (PB), geavanceerde btw, personeel (PC), gewestelijke steun — in voorbereiding.",
