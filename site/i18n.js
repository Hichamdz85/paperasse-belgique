...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      card_independant_desc: "Indépendant personne physique : IPP, cotisations sociales INASTI, TVA, comptabilité simplifiée et dossier professionnel structuré.",
      card_soon_title: "Bientôt",
      card_soon_desc: "TVA avancée, autres métiers — en préparation.",
    ...
    nl: {
      ...
      card_independant_desc: "Zelfstandige natuurlijke persoon: personenbelasting, sociale bijdragen (RSVZ), btw, vereenvoudigde boekhouding en gestructureerd professioneel dossier.",
      card_soon_title: "Binnenkort",
      card_soon_desc: "Geavanceerde btw, andere beroepen — in voorbereiding.",
